...
#define ARR_TIME   9.00 	    // Mean time between arrivals in seconds
...
int main(void)
{
  ...
  ofstream output2;
  ofstream output3;
  output.open ("output_real_time_9_2.txt");
  output2.open ("output_debugging_9_2.txt");
  output3.open ("output_9_2.txt");
