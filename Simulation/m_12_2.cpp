...
#define ARR_TIME   12.00 	    // Mean time between arrivals in seconds
...
int main(void)
{
  ...
  ofstream output2;
  ofstream output3;
  output.open ("output_real_time_12_2.txt");
  output2.open ("output_debugging_12_2.txt");
  output3.open ("output_12_2.txt");
