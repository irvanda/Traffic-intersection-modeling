...
int main(void)
{
  ...
  output << " Simulation time = " << SIM_TIME << endl;
  output << " Mean time = " << ARR_TIME << endl;
  output << " Mean service time = " << SERV_TIME << endl;
  output << "Counter time for green = " << GREEN/1000 << endl;
  output << "Counter time for red = " << RED/1000 << endl;
  ...
  // Output results
  cout  <<"      "<<  c << " requests" << "              "<< l <<" requests          "<< w << " sec" << endl;
  output  <<"      "<< c << " requests" << "              "<< l <<" requests          "<< w << " sec" << endl;
